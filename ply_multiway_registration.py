...
def load_point_clouds(voxel_size=0.0):
    ...
    print(pcds_list)
    pcds = []
    for i in range(len(pcds_list)-2):
...
o3d.io.write_point_cloud("resources/output/vasca.pcd", pcd_combined_down)
...
saveTxt(pcd_combined_down, "resources/output/vasca_1.txt", 1)
file_name = savePath + "vasca_1.txt"
saveTxt(pcd_combined_down, file_name, 1)
frame_s = o3d.geometry.TriangleMesh.create_coordinate_frame(size=0.05, origin=np.array([0., 0., 0.]))
#o3d.visualization.draw_geometries([pcd_combined_down, frame_s])

print("vasca.pcd generated")
